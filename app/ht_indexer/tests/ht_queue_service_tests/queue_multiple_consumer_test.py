...
class TestHTMultipleQueueConsumer:
    ...
    def test_queue_requeue_message_requeue_false(
        ...
        for method_frame, _, body in multiple_consumer_instance.consume_dead_letter_messages(
            ...
            queue_name=f"{multiple_consumer_instance.queue_manager.queue_name}_dlq",
        ):
            if method_frame:
                ...
                multiple_consumer_instance.positive_acknowledge(
                    dlx_channel, method_frame.delivery_tag
                )
    ...
    def test_queue_requeue_message_requeue_true(
        ...
        assert (
            multiple_consumer_instance.redelivery_count >= multiple_consumer_instance.max_redelivery
