...
#for line in $(cat "$PWD/filter_ids.txt")
#  do
#    ht_id="$line"
#    echo "🔁 Processing record $ht_id"
python document_retriever_service/full_text_search_retriever_service.py --list_ids_path "$PWD/filter_ids.txt" --document_repository pairtree
