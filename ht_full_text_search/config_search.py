...
SOLR_URL = {"prod": "http://localhost:8081/solr/core-1x/",
            "dev": "http://localhost:8983/solr/#/core-x/"}
...
QUERY_PARAMETER_CONFIG_FILE = "/".join([currentdir, "config_files/full_text_search/config_query.yaml"])
FACET_FILTERS_CONFIG_FILE = "/".join([currentdir, "config_files/full_text_search/config_facet_filters.yaml"])
